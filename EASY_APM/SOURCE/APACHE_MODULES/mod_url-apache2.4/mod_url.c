...
void redurl_mem_error (const request_rec * s, const char * file, int line, int module_index, char * r)
{
	ap_log_rerror (file, line, module_index, APLOG_ERR, APR_ENOPOOL, s,
